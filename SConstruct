...
if env['EMSCRIPTEN']:
  ...
  base_flags = '-g3 -O3 -s DISABLE_EXCEPTION_CATCHING=2 -s ASM_JS=1 -s USE_ZLIB=1 -s EXPORTED_FUNCTIONS=\'[\"_main\",\"_setGamePadValue\"]\' -s EXTRA_EXPORTED_RUNTIME_METHODS=\'[\"ccall\", \"cwrap\"]\''
